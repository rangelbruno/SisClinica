...
import beans.session.ConsultaFacade;
...
public class ConsultaController implements Serializable {
    ...
    @EJB
    private beans.session.ConsultaFacade ejbFacade;
    ...
    public Consulta getConsulta(java.lang.Integer id) {
    ...
    public static class ConsultaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getConsulta(getKey(value));
        }
